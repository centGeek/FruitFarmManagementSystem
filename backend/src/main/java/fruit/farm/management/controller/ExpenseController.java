...
public class ExpenseController {
    ...
    public ResponseEntity<Page<ExpenseResponse>> getExpenses(
            ...
            @RequestParam(required = false) Integer month, @RequestParam(required = false) Long sectorId,
