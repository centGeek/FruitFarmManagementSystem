INSERT INTO user_profile_entity (name, surname, nickname, phone_number, email, is_active, role_id, gardener_id, creation_date)
...
INSERT INTO user_credentials_entity (user_id, password_hash)
