...
/**The component of Search engine on map
 * It uses Nominatim API OpenStreetMap to find places in PL
 * 
 * @param {Object} props
 * @param {L.Map} props.map
 * @param {string} [props.placeholder]
 * @param {string} [props.countryCode]
 * @param {number} [props.resultsLimit]
 * @param {number} [props.minSearchLength]
 * @param {number} [props.searchDelay] 
 * @param {number} [props.markerDuration]
...
const LocationSearch = ({ 
  ...
  /**
    Find location using Nominatim API
   */
