                    ...
                    <div className="space-y-4 mb-6">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full p-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500"
                            >
                        ...
                        {selectedType && (
                            <>
                                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                                    <p className="text-sm text-blue-800 dark:text-blue-300">{t(`common:notificationType.${selectedType.value}.description`)}</p>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500"
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
...
export const NotificationItem: React.FC<{
    ...
    return (
        <div className={`border-2 rounded-xl p-5 transition-all ${notification.enabled ? 'border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50'}`}>
            <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4 flex-1">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${notification.enabled ? 'bg-blue-100 dark:bg-blue-900/30' : 'bg-gray-200 dark:bg-gray-700'}`}>
                        <Icon className={`w-6 h-6 ${notification.enabled ? 'text-blue-600 dark:text-blue-300' : 'text-gray-500 dark:text-gray-400'}`} />
                    </div>
                    <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                            <h3 className="font-semibold text-gray-900 dark:text-gray-50 text-lg">
                                {typeLabel}
                            </h3>
                            <span className={`px-2 py-1 rounded text-xs font-medium ${notification.enabled ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300'}`}>
                                {notification.enabled ? t('rules.active') : t('rules.inactive')}
                            </span>
                        </div>
                        <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">{typeDescription}</p>

                        <div className="grid grid-cols-2 gap-3">
                            <div className="flex items-center gap-2 text-sm bg-white dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700">
                                <Thermometer className="w-4 h-4 text-gray-500 dark:text-gray-400" />
                                <div>
                                    <span className="text-gray-500 dark:text-gray-400 text-xs">{t('rules.thresholdLabel')}</span>
                                    <span className="font-semibold text-gray-900 dark:text-gray-50 ml-1">
                            ...
                            <div className="flex items-center gap-2 text-sm bg-white dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700">
                                ...
                                <div>
                                    <span className="text-gray-500 dark:text-gray-400 text-xs">{t('rules.forecastLabel')}</span>
                                    <span className="font-semibold text-gray-900 dark:text-gray-50 ml-1">{daysLabel}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    <button
                        ...
                        className="p-2 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-300 rounded-lg hover:bg-orange-200 dark:hover:bg-orange-900/50"
                        title={t('rules.edit')}
                    >
                    ...
                    <button
                        ...
                        className={`p-2 rounded-lg ${notification.enabled ? 'bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-300 hover:bg-green-200 dark:hover:bg-green-900/50' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
                    ...
                    <button
                        ...
                        className="p-2 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-300 rounded-lg hover:bg-red-200 dark:hover:bg-red-900/50"
