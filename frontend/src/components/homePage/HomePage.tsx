        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-4 md:p-6 font-sans">
            <div className="max-w-7xl mx-auto">
                <header className="mb-6">
                    ...
                    <p className="text-gray-600 text-sm md:text-base">{t("header.subtitle")}</p>
                </header>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white rounded-2xl shadow-xl p-4 md:p-6 border border-gray-200">
                            <div className="flex items-center justify-between mb-5">
                                <h2 className="text-lg md:text-xl font-bold text-gray-900 flex items-center"><span className="mr-2">📬</span> {t("news.title")}</h2>
                            </div>
                    ...
                    <div className="lg:col-span-1 lg:-mt-20">
                        <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl shadow-xl p-4 md:p-5 border border-orange-200 lg:sticky lg:top-2">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h2 className="text-base md:text-lg font-bold text-gray-900">{t("weather.title")}</h2>
                            </div>
                            ...
                            {isCheckingAlerts ? (
                                <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6">
                                    <div className="flex flex-col items-center justify-center gap-3">
                                        ...
                                        <span className="text-orange-800 font-medium text-sm text-center">{t("weather.checking")}</span>
                                    </div>
                                </div>
                            ) : weatherError ? (
                                ...
                                <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 text-center">
                                    ...
                                    <p className="text-gray-700 font-medium mb-1 text-sm md:text-base">{t("weather.noAlertsTitle")}</p>
                                    <p className="text-gray-600 text-xs md:text-sm">
                                        <Trans
                                            t={t}
                                            i18nKey="weather.noAlertsHint"
                                            components={{
                                                weatherLink: <Link to="/weather" className="font-bold underline text-red-800 hover:text-red-900" />
                                            }}
                                        />
                                    </p>
                                </div>
